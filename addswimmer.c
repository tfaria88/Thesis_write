...
BEGIN {
    ...
    bond_strong  =  # bond style of inside bonds of the swimmer
    bond_passive =  # bond style of the passive (head and tail ) of the swimmer
    bond_head_flesh =  # bond style of the flesh in the head of the swimmer

    n_not_active_types =  # the number of non active type of the bonds (strong, passive and head)
